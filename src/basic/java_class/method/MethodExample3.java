package basic.java_class.method;
...
static  void  divide(int n1,int n2){
    ...
    public static void main(String[] args) {
        ...
        //메서드 타입이 void가 아닐 경우에는 return값이 무조건 와야한다.
        //if문을 사용해도 각 구문에 return값을 선언해야 한다.
        //void문이어도 return을 탈출 구문으로써 사용할 수 있다.

        //int r4=multi(10,7); (x)
        //print 는 void 함수를 출력할 수 없다.
        multi(10,7);

        multi(add(3,4),add(4,7));//7,11
