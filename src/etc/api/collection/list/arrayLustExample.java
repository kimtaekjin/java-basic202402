...
//한번에 객체 많이 추가하기
        Collections.addAll(score,78,100,89,79,21,56,100);

        System.out.println(score);


        //컬렉션에서의 등장 횟수 구하기.
        System.out.println("점 학생 수: "+ Collections.frequency(score,100));

        //최대값, 최소값 구하기
        System.out.println("최대값: "+Collections.max(score));
        System.out.println("최소값: "+Collections.min(score));

        //오름차 정렬( 작은값부터 순서대로 커지는정렬)
        ...
        //두 요소의 위치를 교체:awap(리스트,i,j )
        Collections.swap(score,3,7);
        System.out.println(score);

        //리스트 내의 요소를 무자위로 섞기
//        Collection.shuffle(score);
//        System.out.println(score);
//
//        //원하는 값으로 컬렉션 초기화
//        Collection.fill(score,100);
//        System.out.println(score);
