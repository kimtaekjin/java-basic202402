...
public class Sorting {
    ...
    public static void main(String[] args) {
        ...
        menuList.stream()
                .filter(dish -> dish.getCalories()<500) //칼로리가 500미만인 애들만 거르기
                .sorted(comparing(Dish::getCalories).reversed())//정렬(높은 순)
                .limit(3)//정렬된 애들 중 상위 3개만 짜르기
                .collect(Collectors.toList())//리스트로 포장해줘
