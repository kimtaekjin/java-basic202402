...
*/
    ...
    void printNumber(int c){//매개변수 (지역 변수의 일종)
        int b=10; //지역 변수 -> 반드시 초기화를 수동으로 해야한다.
        System.out.println("필드a = " + a);
    ...
    void foo(){
        System.out.println("필드a = " + a);
// System.out.println("지역변수 b = " + b);(x) ->지역변수 매개체를 가져올 수 없다.
