...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("정사각형의 넓이는: "+cal.calcRectArea(5));

        calculator cal2 =new calculator();

        System.out.println("직사각형의 넓이는: "+cal.calcRectArea(10,20));

        calculator cal3 =new calculator();

        System.out.println("사다리꼴의 넓이는: "+cal.calcRectArea(5,13,7));
