...
public class String_Quize {
    /*
         1. 주민등록번호 13자리를 입력받습니다.
         2. 주민등록번호는 -을 포함해서 받을 예정입니다.
         3. 13자리가 아니라면 다시 입력받습니다.
         4. ex)
         921013-1234567 ->1992년10월13일 32세 남자
         960223-2345678 ->1996년2월23일 28세 여자
         031125-3456789 ->2003년 11월 25일 21세 남자
         031125-4123456 ->2003년11월25일 21세 여자
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            System.out.printf("%d년%s월 %s일 %s세 %s\n",year,month,day,age,gender);
